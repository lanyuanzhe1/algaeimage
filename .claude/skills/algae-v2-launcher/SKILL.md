...
3. If FREE, launch in background:
   ```bash
   cd e:/code/codex/code/algae_image_v2 && "A:/Anaconda_envs/envs/ican/python.exe" desktop_launcher.py
   ```
...
1. Find the background task that launched `desktop_launcher.py` and call `TaskStop` on it.
